...
<div class="card" id="container">
    ...
    <div class="card-body">
        ...
        <br>
        Nombre: <?= $data['user']->first_name . ' ' . $data['user']->last_name_1 . ' ' . $data['user']->last_name_2 ?>
        <br>
        Dirección: <?= $data['user']->address ?>
        <br>
        Ciudad: <?= $data['user']->city ?>
        <br>
        Provincia: <?= $data['user']->state ?>
        <br>
        Código Postal: <?= $data['user']->zipcode ?>
        <br>
        ...
        <table class="table table-stripped" width="100%">
            ...
            <?php foreach($data['data'] as $key => $value) : ?>
                <tr>
                    <td><img src="<?= ROOT ?>img/<?= $value->image ?>" width="105"
                             alt="<?= $value->name ?>"></td>
